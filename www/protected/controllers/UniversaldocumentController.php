...
// данные реквизитов
        ...
        $contragent_osnovanie2 = $nc->q($contragent_info_model[0]->osnovaniye_dogovora);
        $contragent_osnovanie=str_replace('я','и',$contragent_osnovanie2[1])." ".$contragent_info_model[0]->text_osnovaniye;
        ...
        $replace_template_yur = array(
            ...
            " действующего на основании " .$contragent_osnovanie,// $contragent_osnovanie[1],
