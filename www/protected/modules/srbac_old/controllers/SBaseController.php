 ...
 // public $menu=array();
  ...
  protected function onUnauthorizedAccess() {
    ...
    if (Yii::app()->user->isGuest) {
      ...
      $error["message"] = Helper::translate('srbac', 'Error while trying to access') . ' ' . $mod . "/" . $this->id . "/" . $this->action->id . ".".'<img alt="" style="margin-top: 69px;" src="/img/chimpmedia.jpg" width="300" height="255">';
