...
class UserModule extends CWebModule
{
	...
	public $profileUrl = array("/main"); //array("/user/profile");
	public $returnUrl = array("/main");//array("/user/profile");
	 ...
	 */
	public $rememberMeTime = 30; // 2 hours
