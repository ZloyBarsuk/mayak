...
<div class="wrapper wrapper-white">
    <div class="page-subtitle">
        ...
        <?php echo CHtml::beginForm(CHtml::normalizeUrl('universaldocument/printobracheniye'), 'post', array('style' => 'padding:0 2%;')); ?>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="alert alert-info alert-dismissible"
                             style="padding:5px;" role="alert">
                            <strong>Формат листа , схема преобразования (участка/раздела) </strong>
                        </div>


                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo CHtml::label('Формат схемы (А3,А4)', ''); ?>

                                <?php echo CHtml::textField('format_lista', '', array('class' => 'form-control')); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="form-group">
                                    <?php echo CHtml::label('Кол. листов протокола', ''); ?>

                                    <?php echo CHtml::textField('kvo_listov_prot', '', array('class' => 'form-control')); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="form-group">
                                    <?php echo CHtml::label('Кол. листов сводного плана', ''); ?>

                                    <?php echo CHtml::textField('kvo_listov_plan', '', array('class' => 'form-control')); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <?php echo CHtml::label('Схема преобразования', ''); ?>

                                    <?php echo CHtml::textField('schema', '', array('class' => 'form-control')); ?>
                                </div>
                            </div>
                        </div>
    ...
    <div class="form-group">
        ...
        <?php echo CHtml::ajaxSubmitButton('Печать', '',
            ...
            array(
                ...
                'type' => 'submit',
                'id' => 'print_obracheniye', //. rand(1, 50000),// рандомный айди для удаления дублей при аджаксе, костыль
