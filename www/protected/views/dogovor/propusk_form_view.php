...
<div class="wrapper wrapper-white">
    <div class="page-subtitle">
       ...
       <?php echo CHtml::beginForm(CHtml::normalizeUrl('universaldocument/printpropusk') , 'post', array('style' => 'padding:0 2%;')) ; ?>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <?php echo CHtml::label('список сотрудников по объекту', ''); ?>
                                <?php // echo $form->textField($model,'id_avtor',array('class'=>'form-control')); ?>
                                <?php  echo CHtml::dropDownList('users_list', '', CHtml::listData(User::model()->findAll(), 'id', 'username'),array('multiple'=>'multiple','height'=>'700px;')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="alert alert-info alert-dismissible"
                             style="padding:5px;" role="alert">
                            <strong>Сроки проведения работ на объекте </strong>
                        </div>


                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo CHtml::label('дата работ с:', ''); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="form-group">
                                    <?php echo CHtml::label('дата работ по:', ''); ?>
    ...
    <div class="form-group">
        ...
        <?php echo CHtml::ajaxSubmitButton( 'Печать', '',
            ...
            array(
                ...
                'type' => 'submit',
                'id' => 'print_propusk' , //. rand(1, 50000),// рандомный айди для удаления дублей при аджаксе, костыль
