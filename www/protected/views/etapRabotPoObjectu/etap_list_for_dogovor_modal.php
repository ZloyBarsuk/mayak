                ...
                $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'value' => function ($data,$data_info_objecta) {

                                $pole_work = array(121 => 'полевые работы', 122 => 'камеральные работы', 123 => 'межевые работы',);
                                // 121- полевые работы
                                // 122- камеральныеработы
                                // 123- межевые работы
                                if (key_exists($data->spr_etap_rabot->id, $pole_work)) {

                                    // return $pole_work[$data->spr_etap_rabot->id];
                                  //  $data_info_objecta=$data->spr_etap_rabot->id;
                                  global  $data_info_object;
                                    $data_info_object =$data->spr_etap_rabot->id;

                                   // $fuck= (key_exists((int)$data->spr_etap_rabot->id,$pole_work = array(121 => 'полевые работы', 122 => 'камеральные работы', 123 => 'межевые работы',)))?CController::createUrl("/index.php/soprovoditelniylist/update", array("id"=>$data->id_objecta)):CController::createUrl("/etaprabotpoobjectu/update", array("id"=>$data->id));
                                  // var_dump(key_exists((int)$data->spr_etap_rabot->id,$pole_work = array(121 => 'полевые работы', 122 => 'камеральные работы', 123 => 'межевые работы',)));
//var_dump($data->spr_etap_rabot->id);
                                    return  '<a style="color:red;" class="update_item_etap_rabot" title="обновить полевые работы" href="/soprovoditelniylist/infobydogovor/'.$data->id_objecta.'"'.'>'.$data->spr_etap_rabot->etap_rabot.'</a>';
                                }
                                else{
                                    return $data->spr_etap_rabot->etap_rabot;
                                }
                        ...
                        array(
                            ...
                            // 'name' => 'Дата внесения (Дата выдачи поля)',
                        ...
                        array(
                            ...
                            // 'name' => 'Дата внесения (Дата сдачи поля)',
                        ...
                        array(
                            ...
                            (
                                ...
                                (
                                  ...
                                  //  'url' => ,
                                  //  'url' =>key_exists($data->spr_etap_rabot->id,$pole_work = array(121 => 'полевые работы', 122 => 'камеральные работы', '123' => 'межевые работы',))?'CController::createUrl("/index.php/soprovoditelniylist/update", array("id"=>$data->id_objecta))':'CController::createUrl("/etaprabotpoobjectu/update", array("id"=>$data->id))',
'url'=>'CController::createUrl(key_exists($data->spr_etap_rabot->id,$pole_work = array(121 => \'полевые работы\', 122 => \'камеральные работы\', \'123\' => \'межевые работы\',))?"/soprovoditelniylist/infobydogovor":"/etaprabotpoobjectu/update", array("id"=>key_exists($data->spr_etap_rabot->id,$pole_work = array(121 => \'полевые работы\', 122 => \'камеральные работы\', \'123\' => \'межевые работы\',))?$data->id_objecta:$data->id))',
