                        ...
                        <div class="col-md-5">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <?php echo CHtml::activeDropDownList($model, 'id_otvetstvennogo', CHtml::listData(User::model()->findAll(), 'id', 'username'), array('options' => array(Yii::app()->user->id => array('selected' => true), array('empty' => 'Выбор ответственного')))); ?>
