...
<div class="wide form">
	...
	'method'=>'get',
            ...
            <div class="col-md-5">
                <div class="form-group">
                    <?php echo $form->label($model,'data_podpisaniya'); ?>
                    <?php echo $form->textField($model,'data_podpisaniya',array('class'=>'form-control')); ?>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-5">
                <div class="form-group">
                    <?php echo $form->label($model,'data_vneseniya'); ?>
                    <?php echo $form->textField($model,'data_vneseniya',array('class'=>'form-control')); ?>
                </div>
            </div>
        </div>
