                ...
                array(
                 ...
                 //   'value' => '$data->data_vneseniya?date("d-m-Y", strtotime($data->data_vneseniya)):"нет даты"',
                    'value' => function ($data) {
                        ...
                        if ($data->data_vneseniya == '0000-00-00') {

                            return null;

                        } else {

                            return Yii::app()->dateFormatter->format('dd.MMMM.yyyy', $data->data_vneseniya);
                        }
                ...
                array(
                 ...
                 //   'value' => '$data->data_podpisaniya?date("d-m-Y", strtotime($data->data_podpisaniya)):"нет даты"',
                    'value' => function ($data) {
                        ...
                        if ($data->data_podpisaniya == '0000-00-00') {

                            return null;

                        } else {

                            return Yii::app()->dateFormatter->format('dd.MMMM.yyyy', $data->data_podpisaniya);
                        }
