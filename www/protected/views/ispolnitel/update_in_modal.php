...
<?php Yii::app()->getClientScript()->registerCoreScript('new_bank_ispolnitel'); ?>
                ...
                <div class="tabs">
                    ...
                    <div class="panel-body tab-content">
                        ...
                        <div class="tab-pane" id="contragentinfo">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <?php echo $form->hiddenField($model_contragent_info, 'id_ispolnitel',array('value'=>$model_contragent->id)); ?>
                        ...
                        <div class="tab-pane" id="bank">
                            <?php echo CHtml::button('+ банк', array('class' => 'btn btn-success', 'id' => 'new_bank_ispolnitel', 'style' => ' display:block-inline;')); ?>
                            <p></p>
                            <?php
