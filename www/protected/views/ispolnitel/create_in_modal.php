                ...
                <div class="tabs">
                    <ul class="nav nav-tabs nav-tabs-arrowed" role="tablist">
                        ...
                        <li class="active"><a href="#contragent" role="tab"
                                              data-toggle="tab">Исполнитель</a>
                        </li>
                        <li><a href="#contragentinfo" role="tab" data-toggle="tab">Данные исполнителя</a></li>
                            ...
                            <div class="row">
                                ...
                                $this->widget('ext.EAjaxUpload.EAjaxUpload',
                                    array(
                                        'id' => 'uploadFile',
                                        'config' => array(
                                            'action' => Yii::app()->createUrl('ispolnitel/upload'),
                                            ...
                                            'ispolnitel' => "js:function(id, fileName, responseJSON){
                                              ...
                                              var ispolnitel= jQuery('#Ispolnitel_id').val();
                                              return ispolnitel;
                                        ...
                                        array(
                                            ...
                                            'success' => 'js:function(response){
                                                      ...
                                                      jQuery("body #notifier_success").html(response.message).show("fast").hide(10000);
                                                                  ...
                                                                  alert(response.id_ispolnitel);
                                                          jQuery("body #Ispolnitel_id").val(response.id_ispolnitel);
                                                          jQuery("body #IspolnitelInfo_id_ispolnitel").val(response.id_ispolnitel);
                                                          jQuery("body #Bank_id_contragenta").val(response.id_contragent);
                                                          jQuery("body #Bank_id_ispolnitel").val(response.id_ispolnitel);
                        ...
                        <div class="tab-pane" id="contragentinfo">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <?php echo $form->hiddenField($model_contragent_info, 'id_ispolnitel'); ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <?php echo $form->labelEx($model_contragent_info, 'data_from_csv'); ?>
                                            <?php echo $form->textArea($model_contragent_info, 'data_from_csv', array('rows' => 3, 'cols' => 50, 'class' => 'form-control')); ?>
                                            <?php echo $form->error($model_contragent_info, 'data_from_csv'); ?>
                                        </div>
                                    </div>
...
$(':input','#bank-form').not('#Bank_id_contragenta,#Bank_id_ispolnitel').val('').removeAttr('checked').removeAttr('selected');
