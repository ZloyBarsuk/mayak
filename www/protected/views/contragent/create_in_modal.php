                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php // echo $form->textField($model_contragent_info, 'osnovaniye_dogovora', array('size' => 60, 'maxlength' => 255, 'class' => 'form-control','placeholder'=>'sdf')); ?>
                                            <?php echo $form->textField($model_contragent_info,'osnovaniye_dogovora',array('size'=>60,'maxlength'=>255,'class' => 'form-control','encode'=>false,'style'=>'color:red',  'placeholder'=>'(Устав, Доверенность и тд.)')); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?php echo $form->labelEx($model_contragent_info, 'text_osnovaniye'); ?>
                                           <?php // echo $form->textField($model_contragent_info, 'text_osnovaniye', array('size' => 60, 'maxlength' => 255, 'class' => 'form-control')); ?>
                                            <?php echo $form->textField($model_contragent_info,'text_osnovaniye',array('size'=>60,'maxlength'=>255,'class' => 'form-control','encode'=>false,'style'=>'color:red','placeholder'=>'Пример: №57 от 08.04.2013г.')); ?>

                                            <?php echo $form->error($model_contragent_info, 'text_osnovaniye'); ?>
                                        </div>
                                    </div>
                                </div>
