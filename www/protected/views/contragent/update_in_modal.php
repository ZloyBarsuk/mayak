                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo $form->textField($model_contragent_info,'osnovaniye_dogovora',array('size'=>60,'maxlength'=>255,'class' => 'form-control','style'=>'color:red','encode'=>false,)); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo $form->textField($model_contragent_info,'text_osnovaniye',array('size'=>60,'maxlength'=>255,'class' => 'form-control','style'=>'color:red','encode'=>false,)); ?>
