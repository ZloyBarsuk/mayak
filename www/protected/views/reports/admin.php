                                ...
                                <div class="tabs">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="active"><a href="#tab-OborotDogovors" role="tab" data-toggle="tab"
                                                              aria-expanded="true">Отчет по договорам</a></li>
                                        <li class=""><a href="#tab-OborotContragents" role="tab" data-toggle="tab"
                                                        aria-expanded="false">Отчет по контрагентам</a></li>
                                        ...
                                        <div class="tab-pane active" id="tab-OborotDogovors">
                                            <div class="wrapper wrapper-white">
                                                <div class="page-subtitle">
                                                    ...
                                                    <p class="note">Поля помечены <span class="required">*</span>
                                                    ...
                                                    <div class="form-group">
                                                        <?php echo CHtml::ajaxSubmitButton('Создать', $this->createUrl('reports/OborotDogovor'), array(
