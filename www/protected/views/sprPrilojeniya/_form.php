            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo $form->labelEx($model,'vid_prilojeniya'); ?>
                                    <?php echo $form->textField($model,'vid_prilojeniya',array('size'=>60,'maxlength'=>255,'class'=>'form-control')); ?>
                                    <?php echo $form->error($model,'vid_prilojeniya'); ?>
                                </div>
                            </div>
