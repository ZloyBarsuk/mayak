            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo $form->labelEx($model,'naimenovaniye'); ?>
                                    <?php echo $form->textField($model,'naimenovaniye',array('size'=>60,'maxlength'=>300,'class'=>'form-control')); ?>
                                    <?php echo $form->error($model,'naimenovaniye'); ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo $form->labelEx($model,'procent_ot_summi'); ?>
                                    <?php echo $form->textField($model,'procent_ot_summi',array('size'=>5,'maxlength'=>5,'class'=>'form-control','style'=>'width:100px;')); ?>
                                    <?php echo $form->error($model,'procent_ot_summi'); ?>
                                </div>
                            </div>
