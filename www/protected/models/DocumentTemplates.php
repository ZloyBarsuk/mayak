...
class DocumentTemplates extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('actualnost', 'length', 'max' => 1),
            array('date,parent_title,parent_id', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, title, content,parent_title,parent_id, actualnost,type, date', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'content' => 'Содержание в формате HTML',
    ...
    public function search()
    {
        ...
        $criteria->compare('actualnost', $this->actualnost, true);
