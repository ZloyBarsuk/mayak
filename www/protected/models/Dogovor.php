...
class Dogovor extends CActiveRecord
{
    ...
    public function CreateEtapRabot()
    {
        ...
        $object_Rabot->id_dogovor=$this->id;
        ...
        $etap_rabot->data_nachala_rabot = $this->created_date;
        $etap_rabot->id_spr_etap_rabot = 124;
        $etap_rabot->data_okonchaniya_rabot = $this->created_date;
        $etap_rabot->id_otvetstvennogo = $this->id_author ? $this->id_author : Yii::app()->user->id;
