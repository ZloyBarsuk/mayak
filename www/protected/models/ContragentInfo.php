...
class ContragentInfo extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('email, osnovaniye_dogovora,text_osnovaniye', 'length', 'max' => 255),
            array('comments, yur_address, fiz_address, record_date, data_from_csv_dla_pravki', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, id_contragent, id_author, nds, comments, pasport, inn, kpp, okpo, ogrn, ogrnip, phone, fax, site, yur_address, fiz_address, director, doljnost, zamestitel, email, logo_path, osnovaniye_dogovora,text_osnovaniye, record_date, data_from_csv_dla_pravki', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels()
    {
        ...
        return array(
            ...
            'osnovaniye_dogovora' => 'основание (ИМ. падеж)',
            'text_osnovaniye' => 'текст основания',
