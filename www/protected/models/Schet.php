...
class Schet extends CActiveRecord
{
    ...
    public function CreateEtapRabot()
    {
        ...
        $object_Rabot = ObjectRabot::model()->findByAttributes(array('id_dogovor' => $this->id_dogovor));
        ...
        $etap_rabot->id_objecta = $object_Rabot->id;
        $etap_rabot->data_nachala_rabot = $this->data_scheta;
        $etap_rabot->id_spr_etap_rabot = 46;
        $etap_rabot->data_okonchaniya_rabot = $this->data_scheta;
