...
jQuery('body').on('click', '#object-grid a.item_tehzadaniye', function () {

    var object_id = jQuery(this).closest("tr").attr("id");

    jQuery.ajax({
        type: 'POST',
        url: '/dogovor/tehzadaniye/',
...
jQuery('body').on('click', '#print_tehzadanie', function () {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '/universaldocument/printtehzadaniye/',
        data: {
